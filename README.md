<p align="center">
  <img src="assets/banner.jpg" alt="Чуковский — литературный редактор русского текста: смысл, ясность, голос. Живой как жизнь">
</p>
...
<p align="center">
  <img src="assets/hero.jpg" alt="Чуковский — литературный редактор: живые слова (живой, точный, ясный) вместо мёртвых канцелярских (осуществляет, в рамках, является)"><br>
  <sub><i>Живые слова вместо мёртвых — смысл, ясность, голос</i></sub>
</p>
...
| **Ритм** | «почини ритм», «текст монотонный», «сплошная парцелляция», «рубленые фразы» | чинит ритмическую монотонность нейротекста (стена длинных / сплошная парцелляция), бережёт авторский ритм |
...
- **Ритмическая монотонность нейротекста:** стена одинаковых предложений или сплошная
  парцелляция («Коротко. Точно. По делу.») — правит. Авторский ритм и парцелляцию-приём — бережёт.
...
(Чуковский, Нора Галь, Ильяхов): живой язык против канцелярита, факт против пустой
...
«Чуковский» — скил для редакторов из семьи **[рИИдактор](https://redaktozavr.ru/rAIdactor?utm_source=skills)**, рассылки про
...
| **Чуковский** | Смысл, структура, голос, канцелярит | LLM |
...
Чуковский идёт **первым**: сначала чинят смысл, структуру и голос — нет
смысла полировать пунктуацию и типографику текста, который ещё будут
переписывать по содержанию.
## Лицензия
